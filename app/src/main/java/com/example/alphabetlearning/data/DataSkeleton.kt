...
object DataSkeleton {
    ...
    private val ALEF_Additional = arrayListOf<SkeletonShape>(
        SkeletonShape(PointF(900f, 125f), PointF(700f, 175f), ALEF_Mid_Addi, defaultAdditional, defaultCurveTools)
    )
    val ALEF_Skeleton_Cap = SkeletonShape(PointF(300f, 300f), PointF(300f, 700f),defaultMiddlePoint, defaultAdditional, defaultCurveTools)
    ...
    private val BE_Addi_Sm = arrayListOf(
        SkeletonShape(PointF(850f, 650f), PointF(860f, 650f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    ...
    private val BE_Addi_Cap = arrayListOf(
        SkeletonShape(PointF(400f, 650f), PointF(410f, 650f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    ...
    private val PE_Addi_Sm = arrayListOf(
        SkeletonShape(PointF(895f, 650f), PointF(885f, 650f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(815f, 650f), PointF(825f, 650f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(850f, 700f), PointF(860f, 700f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )

    private val PE_Addi_Cap = arrayListOf<SkeletonShape>(
        SkeletonShape(PointF(440f, 650f), PointF(450f, 650f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(360f, 650f), PointF(370f, 650f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(400f, 700f), PointF(410f, 700f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    ...
    private val TE_Addi_Sm = arrayListOf(
        SkeletonShape(PointF(895f, 450f), PointF(885f, 450f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(815f, 450f), PointF(825f, 450f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )

    private val TE_Addi_Cap = arrayListOf<SkeletonShape>(
        SkeletonShape(PointF(440f, 450f), PointF(450f, 450f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(360f, 450f), PointF(370f, 450f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    ...
    private val SE_Addi_Sm = arrayListOf(
        SkeletonShape(PointF(895f, 450f), PointF(885f, 450f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(815f, 450f), PointF(825f, 450f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(850f, 400f), PointF(860f, 400f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    private val SE_Addi_Cap = arrayListOf<SkeletonShape>(
        SkeletonShape(PointF(440f, 450f), PointF(450f, 450f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(360f, 450f), PointF(370f, 450f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(400f, 400f), PointF(410f, 400f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    ...
    private val Jim_Addi_Sm = arrayListOf(
        SkeletonShape(PointF(800f, 700f), PointF(810f, 700f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    private val Jim_Addi_Cap = arrayListOf(
        SkeletonShape(PointF(400f, 800f), PointF(410f, 800f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    ...
    private val Che_Addi_Sm = arrayListOf(
        SkeletonShape(PointF(775f, 700f), PointF(785f, 700f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(850f, 700f), PointF(860f, 700f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(815f, 750f), PointF(825f, 750f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    private val Che_Addi_Cap = arrayListOf(
        SkeletonShape(PointF(375f, 800f), PointF(385f, 800f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(450f, 800f), PointF(460f, 800f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(415f, 850f), PointF(425f, 850f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    ...
    val HE_Skeleton_Sm = SkeletonShape(PointF(750f, 500f), PointF(925f, 600f), Jim_Middle_Sm, defaultAdditional, defaultCurveTools, 20)
    val HE_Skeleton_Cap = SkeletonShape(PointF(275f, 500f), PointF(475f, 600f), Jim_Middle_Cap, defaultAdditional, defaultCurveTools, 50)

    // _________________________________________________________________________________________
    // 9. khe : derived form Jim

    private val Khe_Addi_Sm = arrayListOf(
        SkeletonShape(PointF(800f, 350f), PointF(810f, 350f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    private val Khe_Addi_Cap = arrayListOf(
        SkeletonShape(PointF(350f, 350f), PointF(360f, 350f),defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    ...
    val DAL_Skeleton_Sm = SkeletonShape(PointF(700f, 500f), PointF(700f, 500f), DAL_Middle_Sm, defaultAdditional, defaultCurveTools, 95)
    val DAL_Skeleton_Cap = SkeletonShape(PointF(250f, 500f), PointF(250f, 500f), DAL_Middle_Cap, defaultAdditional, defaultCurveTools, 95)

    // _________________________________________________________________________________________
    // 11. zal : derived from dal

    private val Zal_Addi_Sm = arrayListOf(
        SkeletonShape(PointF(825f, 375f), PointF(835f, 375f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    private val Zal_Addi_Cap = arrayListOf(
        SkeletonShape(PointF(375f, 375f), PointF(385f, 375f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    ...
    val RE_Skeleton_Sm = SkeletonShape(PointF(850f, 550f), PointF(625f, 850f), defaultMiddlePoint, defaultAdditional, CurveTools(150), 75)
    val RE_Skeleton_Cap = SkeletonShape(PointF(350f, 550f), PointF(125f, 850f), defaultMiddlePoint, defaultAdditional, CurveTools(150), 75)
    ...
    private val Ze_Addi_Sm = arrayListOf(
        SkeletonShape(PointF(845f, 400f), PointF(855f, 400f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    private val Ze_Addi_Cap = arrayListOf(
        SkeletonShape(PointF(345f, 400f), PointF(355f, 400f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    ...
    private val Zhe_Addi_Sm = arrayListOf(
        SkeletonShape(PointF(800f, 400f), PointF(810f, 400f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(890f, 400f), PointF(900f, 400f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(845f, 325f), PointF(855f, 325f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)

    )
    private val Zhe_Addi_Cap = arrayListOf(
        SkeletonShape(PointF(300f, 400f), PointF(310f, 400f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(390f, 400f), PointF(400f, 400f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(345f, 325f), PointF(355f, 325f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    ...
    val SIN_Skeleton_Sm = SkeletonShape(PointF(950f, 650f), PointF(750f, 650f), Sin_Middle_Sm, defaultAdditional, defaultCurveTools, 120)
    val SIN_Skeleton_Cap = SkeletonShape(PointF(600f, 650f), PointF(100f, 650f), Sin_Middle_Cap, defaultAdditional, defaultCurveTools, 150)

    // _________________________________________________________________________________________
    // 16. shin : Derived from sin

    private val Shin_Addi_Sm = arrayListOf(
        SkeletonShape(PointF(800f, 500f), PointF(810f, 500f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(890f, 500f), PointF(900f, 500f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(845f, 425f), PointF(855f, 425f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)

    )
    private val Shin_Addi_Cap = arrayListOf(
        SkeletonShape(PointF(450f, 500f), PointF(460f, 500f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(540f, 500f), PointF(550f, 500f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2),
        SkeletonShape(PointF(495f, 425f), PointF(505f, 425f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    ...
    val SAD_Skeleton_Sm = SkeletonShape(PointF(800f, 750f), PointF(650f, 750f), Sad_Middle_Sm, defaultAdditional, defaultCurveTools, 120)
    val SAD_Skeleton_Cap = SkeletonShape(PointF(375f, 750f), PointF(200f, 950f), Sad_Middle_Cap, defaultAdditional, defaultCurveTools, 150)

    // _________________________________________________________________________________________
    // 18 . ZAD : derived from Sad

    private val Zad_Addi_Sm = arrayListOf(
        SkeletonShape(PointF(900f, 500f), PointF(910f, 500f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    private val Zad_Addi_Cap = arrayListOf(
        SkeletonShape(PointF(475f, 500f), PointF(485f, 500f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    ...
    private val Ta_Addi_Sm = arrayListOf(
        SkeletonShape(PointF(700f, 750f), PointF(700f, 500f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 20)
    )
    private val Ta_Addi_Cap = arrayListOf(
        SkeletonShape(PointF(300f, 750f), PointF(300f, 500f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 20)
    )
    ...
    private val Za_Addi_Sm = arrayListOf(
        SkeletonShape(PointF(700f, 750f), PointF(700f, 500f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 20),
        SkeletonShape(PointF(800f, 475f), PointF(810f, 475f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
    private val Za_Addi_Cap = arrayListOf(
        SkeletonShape(PointF(300f, 750f), PointF(300f, 500f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 20),
        SkeletonShape(PointF(400f, 475f), PointF(410f, 475f), defaultMiddlePoint, defaultAdditional, defaultCurveTools, 2)
    )
